...
######################################################################
MODEL_NAME_OR_PATH=/vita-qinyu-models/utu-v1-4b-40layers-32k-v20251208
CONFIG_NAME=${LOCAL_CODE_PATH}/vita_qinyu/models/vita_utu_mtp_sensevoice_xy_v4_51_3/config_from_scratch.json
...
torchrun $DISTRIBUTED_ARGS tools/finetune.py \
    ...
    --deepspeed scripts/deepspeed/ds_config_zero2.json \
