...
######################################################################
MODEL_NAME_OR_PATH=/vita-qinyu-models/Qwen/Qwen3-8B
CONFIG_NAME=${LOCAL_CODE_PATH}/vita_qinyu/models/qwen3_sensevoice_xy_v4_51_3/config_from_scratch.json
...
torchrun $DISTRIBUTED_ARGS tools/finetune_vita_audio2_v4_51_3.py \
    --log_level "info" \
    --do_train \
