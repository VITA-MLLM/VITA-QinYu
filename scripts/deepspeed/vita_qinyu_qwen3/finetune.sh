...
######################################################################
MODEL_NAME_OR_PATH=/vita-qinyu-models/VITA-QinYu-8B
CONFIG_NAME=${LOCAL_CODE_PATH}/vita_qinyu/models/qwen3_sensevoice_xy_v4_51_3/config.json
...
EXTRA_ARGS=
EXTRA_ARGS="$EXTRA_ARGS --tf32 True"
EXTRA_ARGS="$EXTRA_ARGS --deepspeed ${LOCAL_CODE_PATH}/scripts/deepspeed/ds_config_zero2_no_optimizer.json"
